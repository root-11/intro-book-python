...
- **Extend the simulator.** The genetics and predator-prey extensions flagged in the [simulator spec](https://root-11.codeberg.page/intro-book-python/code/sim/SPEC.html) break new ground without leaving the framework you have already built.
